        ...
        <tbody>
            @foreach ($listado as $item)
                ...
                <tr>
                    ...
                    <td class="text-center" style="border-color: #9d9d9d">
                        <select id="edit_planta_{{ $item->id_desglose_recepcion }}" style="width: 100%; height: 26px;"
                    ...
                    <td class="text-center" style="border-color: #9d9d9d">
                        <select id="edit_variedad_{{ $item->id_desglose_recepcion }}" style="width: 100%; height: 26px;"
                    ...
                    <td class="text-center" style="border-color: #9d9d9d">
                        <select id="edit_modulo_{{ $item->id_desglose_recepcion }}" style="width: 100%; height: 26px;">
                    ...
                    <td class="text-center" style="border-color: #9d9d9d">
                        <select id="edit_cosechador_{{ $item->id_desglose_recepcion }}" style="width: 100%; height: 26px;">
                            <option value="">Seleccione</option>
