...
@section('contenido')
    ...
    <section class="content">
        <div id="div_indicadores">
            @include('adminlte.gestion.bodega.crm.partials.indicadores')
        </div>
        ...
        <div class="row" style="margin-top: 10px">
            ...
            <div class="col-md-4 bg-yura_dark border-radius_16" id="div_master_ranking">
                <legend class="text-center" style="margin-bottom: 5px">
                        ...
                        <ul class="dropdown-menu sombra_pequeña" style="top: 28px;">
                            <li>
                                <a href="javascript:void(0)" class="li_criterio_ranking bg-aqua-active"
                                    onclick="$('#criterio_ranking').val('V'); $('.li_criterio_ranking').removeClass('bg-aqua-active'); $(this).addClass('bg-aqua-active'); listar_ranking();">
                                    Ventas
                                </a>
                    ...
                    <strong style="color: white">Ranking <sup>-4 meses</sup></strong>
                </legend>
                <input type="hidden" id="criterio_ranking" value="V">
...
@section('script_final')
    ...
    @include('adminlte.gestion.bodega.crm.script')
@endsection
