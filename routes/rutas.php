...
Route::group(['middleware' => 'autenticacion'], function () {
    ...
    Route::group(['middleware' => 'controlsession'], function () {
        ...
        Route::group(['middleware' => 'permiso'], function () {
            ...
            include "postcosecha/correcion_inventario.php";
            ...
            include 'comercializacion/codigo_dae.php';
            include 'comercializacion/ingreso_guias.php';
            ...
            include 'bodega/pedido_bodega.php';
            include 'bodega/fecha_entrega.php';
            include 'bodega/resumen_pedidos.php';
            include 'bodega/proveedores.php';
            include 'bodega/reporte_ventas.php';
            include 'bodega/etiquetar_peso.php';
            include 'bodega/ranking_productos.php';
            ...
            include 'bodega/inventario_bodega.php';
            include 'bodega/crm_bodega.php';
